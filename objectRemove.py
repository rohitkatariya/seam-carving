...
class ObjectRemoval:
    ...
    def __init__(self,img,radius_circle,object_removal_flag=True,save_obj_flag=False):
        self.img = img.copy()
        ...
        while np.min(self.object_mask)==0:
...
if __name__=="__main__":
    ...
    sc = ObjectRemoval(img,radius_circle,object_removal_flag=True,save_obj_flag=save_obj_flag)
